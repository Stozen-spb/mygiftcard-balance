<template>
	<div class="component-container">
		<button v-if="!formVisible" type="button" @click='formVisible = !formVisible' class="btn add-card">Добавить карту</button>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="fa fa-credit-card text-info" aria-hidden="true"></i></div>
                                        </div>
                                        <input 
                                        	type="text" 
                                        	v-model='cardNumber'
